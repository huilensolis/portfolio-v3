        ...
        {[...posts, ...posts, ...posts, ...posts].map((blogPost, i) => (
          <li key={i} className="group">
            <Link href={`/engineering/blog/post/${blogPost.slug}`}>
              <article className="flex flex-col gap-24 bg-gray-100 dark:bg-neutral-800/60 rounded-md border border-gray-200/40 dark:border-neutral-700/40 p-4 hover:dark:brightness-125 hover:bg-gray-200/60 duration-150 transition-all">
