...
export function Modal({ title, children }: TProps) {
  ...
  return createPortal(
    ...
    >
      <article
        className={[
          "w-full md:max-w-3xl md:h-screen flex flex-col gap-4 h-full bg-neutral-100 md:border-l-2 md:border-gray-300 shadow-2xl shadow-neutral-700 overflow-y-auto",
